...
beautiful.init("/home/freyes/.config/awesome/zenburn.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "XF86AudioLowerVolume", function () awful.util.spawn_with_shell("volmgr +5") end),
    awful.key({                   }, "XF86AudioRaiseVolume", function () awful.util.spawn_with_shell("volmgr -5") end),
    awful.key({                   }, "XF86Battery", function () awful.util.spawn_with_shell("battery") end),
    -- Prompt
